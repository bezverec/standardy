...
Tento dokument představuje pracovní návrh metodiky pro tvorbu preservation masterů obrazových dat při digitalizaci kulturního dědictví. Jeho cílem je formulovat odborně konzistentní, měřitelný a institucionálně použitelný rámec pro vznik digitálních reprodukcí, které mohou dlouhodobě sloužit jako důvěryhodná archivní reprezentace fyzických předloh. Metodika vychází zejména z doporučení FADGI, Metamorfoze, ISO 19264, principů ICC color managementu a z požadavků na dlouhodobou správu digitálních objektů.^1^,^2^,^3^,^4^,^5

Text propojuje technické parametry preservation masteru s provozními rozhodnutími digitalizačního workflow. Zabývá se správou barev, standardními RGB prostory, ICC profily, bitovou hloubkou, samplingem, SFR/MTF, tonalitou, white balance, color accuracy, geometrií, targety, QA reporty, formátovou politikou, zásadami skenování a post-processingu i rozlišením mezi RAW daty, preservation masterem a uživatelskými deriváty. Samostatně rozpracovává obrazové vady a artefakty, sekvenční konzistenci produkčních dávek a vztah mezi měřitelnou technickou kvalitou, vizuální kontrolou a auditovatelností procesu.

Součástí metodiky je pracovní ratingový model **DPIR (Digital Preservation Imaging Rating)**, který rozlišuje kvalitu zařízení, workflow a konkrétní produkční dávky. DPIR zavádí ratingové úrovně od DPIR-AAA po DPIR-C, kritické brány pro nejvyšší úrovně kvality, výchozí numerické hodnoty vybraných metrik a minimální požadavky na targetový režim, bitovou hloubku, artefakty, QA dokumentaci a vztah výstupu k označení preservation master. Rating nemá nahradit plné metrické vyhodnocení, ale poskytnout srozumitelnou vrstvu pro projektové zadání, kontrolu kvality, audit a komunikaci mezi institucí, dodavatelem a dlouhodobým správcem dat.
